  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TABLE "reset_password_token" (
        ...
        "userId" integer,
        CONSTRAINT "REL_3fde3055d9d16236c05d030915" UNIQUE ("userId"),
    ...
    await queryRunner.query(
      `INSERT INTO "public"."user"("id","firstName","lastName","email","password")
      VALUES
      (1,E'Roman',E'Iaremchuk',E'dino10bit@gmail.com',E'$2a$12$pqpzDtz5TYY46JRttGsIruk3flAjLFZhTBQHROod9k1hp1FP2Vz8K');`
    )
  }
